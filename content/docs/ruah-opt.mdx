...
> **Coming soon on npm.** Package name: `@ruah-dev/opt`. Not published yet — install commands below are the intended public surface.
...
```bash
npm i -g @ruah-dev/cli @ruah-dev/opt
