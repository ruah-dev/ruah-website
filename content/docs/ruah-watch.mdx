...
> **Coming soon on npm.** Package name: `@ruah-dev/watch`. Not published yet — install commands below are the intended public surface. Hold: not in the current publish batch.
...
```bash
npm i -g @ruah-dev/cli @ruah-dev/watch
