...
> **Coming soon on npm.** Package name: `@ruah-dev/verify`. Not published yet — install commands below are the intended public surface.
...
```bash
npm i -g @ruah-dev/cli @ruah-dev/verify
cd your-repo
ruah verify init
ruah verify run
