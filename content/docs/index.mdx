...
| [`@ruah-dev/guard`](/docs/ruah-guard) | Policies for agent tool calls |
| [`@ruah-dev/verify`](/docs/ruah-verify) | Definition of done as code |
| [`@ruah-dev/opt`](/docs/ruah-opt) | Token X-ray / spend profiler |
| [`@ruah-dev/watch`](/docs/ruah-watch) | Shareable static session replay |
| [`@ruah-dev/eval`](/docs/ruah-eval) | Same task, N executors, receipts |
| [`@ruah-dev/conv`](/docs/ruah-conv) | API spec → curated agent tools |
