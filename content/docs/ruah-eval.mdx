...
> **Coming soon on npm.** Package name: `@ruah-dev/eval`. Not published yet — install commands below are the intended public surface.
...
```bash
npm i -g @ruah-dev/cli @ruah-dev/eval
ruah eval init
